...
- **ENet:** A purpose-built C library for game networking over UDP. Provides per-channel sequencing, selective reliability, connection management, and keep-alives, without TCP-style global ordering.

ENet is battle-tested in production games and has a stable C library accessible via CGo.
