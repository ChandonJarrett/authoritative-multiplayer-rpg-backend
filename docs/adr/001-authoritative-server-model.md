...
1. Clients capture input locally (movement, actions) and send it to the server.
2. The server applies inputs in a deterministic simulation loop (64Hz).
3. The server broadcasts the canonical world state to clients (32Hz).
